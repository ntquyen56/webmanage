                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-8"><input type="date" name="ngaysinh"  value={{$user->ngaysinh}} id="" style="height: 125%; border: grey solid 2px;"></div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-8">
                                <select name="khoa" id="" style="height: 125%; border: grey solid 2px;">
                                    ...
                                    <option {{$user->khoa->id_khoa == $khoa->id_khoa ?"selected" : ""}} value={{$khoa->id_khoa}}>{{$khoa->ten_khoa}}</option>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-8">
                                <select name="trinhdo" id="" class="text-center" style="height: 125%; border: grey solid 2px;">
                                    ...
                                    <option {{$user->trinhdo->id_trinhdo == $trinhdo->id_trinhdo ?"selected" : ""}} value={{$trinhdo->id_trinhdo}}>{{$trinhdo->ten_trinhdo}}</option>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-8"><input type="text" name="lienhe" value={{$user->lienhe}} id="" style="height: 125%; border: grey solid 2px;"></div>
                        </div>
                    </div>
                </div>
