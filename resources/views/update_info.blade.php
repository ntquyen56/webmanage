    ...
    <form action="{{ route('client.handle_update_info') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-7"><input required type="text" name="tengv"  value="{{$user->name}}" id="" style="height: 125%; border: grey solid 2px;"></div>

                        </div>
                        <div class="row mt-3">
                            <div class="col-sm-5 text-right">Ngày sinh</div>
                            <div class="col-sm-7"><input required type="date" name="ngaysinh" value={{ $user->ngaysinh }}
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-8">
                                <select name="khoa" id="" required style="height: 125%; border: grey solid 2px; width: 100%">
                ...
                <div class="row" style="margin: 5% 35%;">
