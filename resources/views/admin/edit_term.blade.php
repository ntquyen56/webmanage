        ...
        <div class="row mt-3 mb-3" style="margin: 4% 5% 2% 5%;">
            <form method="post" action="{{ URL::to('update_term/'.$edit->id_hp)}}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5"><input type="text" name="ma_hp" id="" value="{{ $edit->ma_hp }}" style="width: 70%;" class="input-pr"></div>
                </div>
                <div class="row mt-3">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-5 txt-add">Tên học phần</div>
                    <div class="col-sm-5"><input type="text" name="ten_hp" id="" value="{{ $edit->ten_hp }}" class="input-pr" style=""></div>
                </div>
                <div class="row mt-5">
