...
<head>
    ...
    <title>Hệ thống đăng kí biên soạn giáo trình</title>
...
<body class="antialiased container-fluid">
    <header class="header">
        <div class="text-center justify-content-between  ">
            <div class="row">
                <div class="col-2 justify-content-between text-end mt-2">
                    <img src="{{ asset('image/logo_cit.png') }}" style="width: 100px;" alt="" srcset="">
                </div>
                <div class="col-6 justify-content-between text-start fs-4 fw-bold text-uppercase"
                    style="margin-top: 37px; color: #0008C1;">
