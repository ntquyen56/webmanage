...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: rgb(27, 27, 234);">
            ...
            <li class="nav-item  no-arrow mx-1">
                <a href={{ route('logout') }} style="text-decoration: none;">
                    <div style="color:aliceblue;font-weight: 600;text-align: center;">
                        <i class="fa-solid fa-right-from-bracket"></i> Logout</div>
                </a>
            </li>
            ...
            @if (Auth::user()->group_id == 1)
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{ route('manage.registration_list') }}">Danh sách biên
                                soạn</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                            <a class="collapse-item" href="{{ route('manage.acceptance_list') }}">Danh sách nghiệm
                                thu</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseSixx" class="collapse" aria-labelledby="headingSixx"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @if (Auth::user()->group_id == 1 || in_array(2, $arrRoles))
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTenty" class="collapse" aria-labelledby="headingTenty"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @if (Auth::user()->group_id == 1 || in_array(4, $arrRoles)))
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseEight1" aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-fw fa-cog"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="">
                    ...
                    <div class="row mb-2" style="margin-top: -2px;">
            ...
            <footer class="sticky-footer bg-white">
                ...
                <div class="text-f mb-2 mb-md-0 sticky-footer bg-white text-center" style="font-weight: 600;">
    ...
    <script>
        $(document).ready(function() {
            $('#mytable').DataTable({
                language: {
                    search: "Tìm kiếm",
                    lengthMenu: "Dữ liệu trên 1 trang _MENU_ ",
                    info: "Dữ liệu từ _START_ đến _END_ trên Tổng _TOTAL_ dữ liệu",
